...
public class AttackerMoreDamageStep implements IDamageStep {
    ...
    public float apply(float initialDamage,
        ...
        return initialDamage * (1 + AdvancedARPGAttributesAPI.getData(attackerStatContainer, filteredAttributes)[2]);
    }
}
