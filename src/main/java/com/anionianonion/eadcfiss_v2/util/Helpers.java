...
public class Helpers {
     ...
     */
    public static StatContainer getNewStatContainerByRemappingBtoA(StatContainer a, StatContainer b, String attributeTagToReplace, String replacement) {
    ...
    public static void logDataFromStatContainer(StatContainer statContainer) {
        for(var key : statContainer.getAddedModifiers().keySet()) {
            AnIonianOnionsDamageMegacompatMod.LOGGER.info(statContainer.getAddedModifiers().get(key).toString());
        }

        for(var key : statContainer.getIncreaseModifiers().keySet()) {
            AnIonianOnionsDamageMegacompatMod.LOGGER.info(statContainer.getIncreaseModifiers().get(key).toString());
        }

        for(var key : statContainer.getMoreModifiers().keySet()) {
            AnIonianOnionsDamageMegacompatMod.LOGGER.info(statContainer.getMoreModifiers().get(key).toString());
        }
    }
}
